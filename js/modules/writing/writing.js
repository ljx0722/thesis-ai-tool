...
var WritingModule = (function() {
  ...
  function render(){
    ...
    if(!chapters.length){h+='<div style="text-align:center;padding:60px 20px;color:#94a3b8"><div style="font-size:48px;margin-bottom:12px">✍️</div><h3>论文写作</h3><p style="margin-top:8px">请先在「立项」导入论文或创建大纲</p><button class="btn btn-primary" style="margin-top:16px" onclick="navigateTo(\'setup\')">→ 去立项</button></div>';}
