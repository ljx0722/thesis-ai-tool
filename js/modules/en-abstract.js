...
function runEnAbstract(container) {
  ...
  c.innerHTML = '<div class="module-panel" style="max-width:800px;margin:0 auto">' +
    '<h4>🌐 英文摘要润色</h4>' +
    '<div style="padding:12px;background:rgba(99,102,241,.05);border-radius:10px;margin-bottom:16px;font-size:.75rem;color:rgba(255,255,255,.5);line-height:1.7;">支持两种模式：<br><b>翻译模式：</b>中文摘要 → 学术英文摘要<br><b>润色模式：</b>已有英文 → AI润色优化（语法/用词/流畅度）</div>' +
